...
```bash
python3 "$HOME/.claude/skills/codex-delegate/scripts/call_codex.py" \
  --mode read-only \
...
Project-local installation may use:

```bash
python3 ".claude/skills/codex-delegate/scripts/call_codex.py" --mode read-only --task "..."
```
